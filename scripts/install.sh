...
if [ -f "${file1}" ] && [ -f "${file2}" ] && [ -f "${file3}" ]; then
	...
	git clone --recursive https://github.com/bodong-chips/ton-mytonctrl.git mytonctrl
else
	rm -f toninstaller.sh
	wget https://raw.githubusercontent.com/bodong-chips/ton-mytonctrl/master/scripts/toninstaller.sh
